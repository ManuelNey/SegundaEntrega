...
public class UnitTest
{
    ...
    public void NoAgregoPokemons()
    {
        ...
        Assert.That(juego.IniciarEnfrentamiento(),
            Is.EqualTo("La batalla ya ha comenzado o uno de los jugadores no tiene Pokémon."));
    }
    ...
    public void PresicionAciertaYAtaqueNoCritico()
    {
        ...
        double
            numeroesperado =
                85; // su vida queda igual, ya que 85(vida Charmander)- 60(defensa Charmander)- 60(AtaquePidgey)= 85
        double numeroObtenido = menu.GetHpAtacante(); //Vida de charmander ya que pasa a ser el atacante
        Assert.That(numeroesperado, Is.EqualTo(numeroObtenido));
    }
